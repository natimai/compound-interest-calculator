...
import { Clock, ChevronLeft, ChevronRight, Star, Book, DollarSign, LineChart } from 'lucide-react';
    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-bold mb-4">מושגי יסוד בשוק ההון - המילון למשקיע המתחיל</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8">
          <div className="prose dark:prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 p-8 rounded-xl mb-8">
              <h4 className="text-blue-800 dark:text-blue-300 text-xl m-0 mb-4">מפת הדרכים שלכם לשוק ההון</h4>
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                בשיעור זה נלמד את המושגים הבסיסיים ביותר בשוק ההון. הבנת מושגים אלו היא הבסיס 
                לכל השקעה מוצלחת. נלמד על סוגי ניירות ערך, מדדים מרכזיים, ומונחים שכל משקיע חייב להכיר.
              </p>
            </div>
