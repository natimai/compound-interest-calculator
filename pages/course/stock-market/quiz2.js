...
export default function Quiz2() {
  ...
  const allQuestions = [
    ...
    {
      question: "מהו 'כלל 24 השעות' בהשקעות?",
      options: [
        "לבדוק את המניות כל 24 שעות",
        "לחכות 24 שעות לפני כל החלטת השקעה משמעותית",
        "לסחור רק כל 24 שעות",
        "להשקיע כל 24 שעות סכום קבוע"
      ],
      correctAnswer: 1,
      explanation: "כלל 24 השעות ממליץ לחכות יום שלם לפני קבלת החלטות השקעה משמעותיות, כדי להימנע מהחלטות רגשיות."
    },
    {
    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-bold mb-4">בוחן לתרגול - פסיכולוגיה וניהול סיכונים</h1>
