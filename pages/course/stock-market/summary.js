...
export default function Summary() {
  ...
  return (
    <>
      <Head>
        <title>סיכום קורס שוק ההון למתחילים | דריבית</title>
        <meta name="description" content="סיימתם את קורס שוק ההון למתחילים! סיכום כל מה שלמדתם על מניות, אגרות חוב, ניתוח טכני, ניהול תיק השקעות ועוד." />
        <meta name="keywords" content="קורס שוק ההון, סיכום קורס השקעות, לימודי בורסה, השקעות למתחילים, ניהול תיק השקעות" />
        <meta property="og:title" content="סיכום קורס שוק ההון למתחילים | דריבית" />
        <meta property="og:description" content="סיכום מקיף של קורס שוק ההון למתחילים - כל מה שצריך לדעת להתחלת דרככם בעולם ההשקעות" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.deribit.co.il/course/stock-market/summary" />
        <link rel="canonical" href="https://www.deribit.co.il/course/stock-market/summary" />
      </Head>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8">
            <div className="prose dark:prose-invert max-w-none">
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/30 dark:to-blue-900/30 
                p-12 rounded-2xl mb-12 text-center transform hover:scale-105 transition-all duration-300"
              >
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 
                  bg-clip-text text-transparent mb-6 animate-pulse"
                >
                  🎉 כל הכבוד!
                </h2>
                <p className="text-xl text-gray-700 dark:text-gray-300 mb-0">
                  סיימתם את הקורס הבסיסי לשוק ההון - זה הישג משמעותי!
                </p>
              </div>

              <div className="bg-white dark:bg-gray-800 p-8 rounded-xl mb-8 shadow-lg">
                <div className="space-y-6">
                  <p className="text-lg">
                    כבר עכשיו אתם יודעים יותר על שוק ההון מרוב האנשים, ועברתם את המחסום הראשוני 
                    של "זה נשמע מסובך מדי".
                  </p>
                  <p className="text-lg">
                    הבנתם שהשקעות הן לא רק למומחים ואנשי כספים, אלא כלי נגיש לכל מי שמוכן ללמוד 
                    ולהשקיע מזמנו.
                  </p>
                  <p className="text-lg">
