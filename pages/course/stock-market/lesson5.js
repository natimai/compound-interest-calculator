...
export default function Lesson5() {
  ...
  return (
    <>
      <Head>
        <title>ניהול סיכונים בשוק ההון | שיעור 5 | דריבית</title>
        <meta name="description" content="למדו על ניהול סיכונים בשוק ההון - פיזור השקעות, אסטרטגיות הגנה, וכלים מעשיים לצמצום סיכונים בתיק ההשקעות שלכם." />
        <meta name="keywords" content="ניהול סיכונים, פיזור השקעות, סיכון בשוק ההון, אסטרטגיות הגנה, תיק השקעות מאוזן" />
        <meta property="og:title" content="ניהול סיכונים בשוק ההון | קורס שוק ההון" />
        <meta property="og:description" content="למדו על ניהול סיכונים בשוק ההון - פיזור השקעות ואסטרטגיות הגנה" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.deribit.co.il/course/stock-market/lesson5" />
        <link rel="canonical" href="https://www.deribit.co.il/course/stock-market/lesson5" />
      </Head>
      <div>
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="mb-12">
            ...
            <h1 className="text-3xl font-bold mb-4">ניהול סיכונים</h1>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 p-8 rounded-xl mb-8">
                ...
                <div className="bg-white/50 dark:bg-gray-800/50 p-6 rounded-xl">
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-0 mb-0">
                    <li>עקרונות ניהול סיכונים</li>
                    <li>זיהוי וניתוח סיכונים</li>
                    <li>אסטרטגיות לצמצום סיכונים</li>
                    <li>כלים מעשיים לניהול סיכונים</li>
                  </ul>
                </div>
              </div>
