...
export default function KerenHishtalmut() {
  ...
  return (
    <>
      <NextSeo
        title="מדריך קרן השתלמות 2024 | הטבת המס הטובה בישראל"
        description="המדריך המקיף לקרן השתלמות: הטבת המס המשתלמת ביותר בישראל, פטור ממס רווחי הון, השוואת דמי ניהול ותשואות."
        canonical="https://www.deribit.co.il/investment-products/keren-hishtalmut"
        openGraph={{
          title: 'מדריך קרן השתלמות 2024 | הטבת המס הטובה בישראל',
          description: 'המדריך המקיף לקרן השתלמות: הטבת המס המשתלמת ביותר בישראל.',
