               ...
               <section>
                ...
                <section>
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700 dark:text-gray-300">
                     <li><strong>קבלת אישור עקרוני:** פנייה לבנק (או למספר בנקים) עם נתונים ראשוניים (הכנסות, הון עצמי, סכום מבוקש) לקבלת אישור מסגרת אשראי ותנאים ראשוניים. מאפשר לדעת בערך כמה תוכלו ללוות ובאיזה ריביות.</li>
                     ...
                     <li>**אישור סופי (אובליגו):** הגשת כל המסמכים לבנק (חוזה, שמאות, תלושי שכר, עו"ש וכו') לקבלת אישור סופי ומחייב למשכנתא ולתנאיה.</li>
                     <li>**חתימות וביטחונות:** הגעה לסניף הבנק לחתימה על כל מסמכי ההלוואה והשיעבודים.</li>
                     <li>**ביטוחים:** רכישת פוליסות ביטוח חיים וביטוח נכס מתאימות לדרישות הבנק.</li>
                     <li>**רישומים:** רישום הערת אזהרה לטובת הבנק בטאבו/רמ"י ו/או רישום משכון ברשם המשכונות.</li>
                     <li>**העברת הכספים:** לאחר השלמת כל התנאים והביטחונות, הבנק מעביר את כספי ההלוואה ישירות לחשבון המוכר.</li>
                  </ol>
                </section>
